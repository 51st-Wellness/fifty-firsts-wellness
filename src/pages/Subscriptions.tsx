...
const Subscriptions: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      // plansResponse is now directly SubscriptionPlan[] array
      ...
      if (activeSubResponse.success) {
        ...
        console.warn("Failed to fetch active subscription:", activeSubResponse.message);
        // Don't show error toast for non-critical failure
      }
    } catch (error: any) {
      ...
      <main className="min-h-screen relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen">
          <div className="text-center max-w-md mx-auto px-4">
            ...
            <button
              onClick={fetchData}
              className="bg-gradient-to-r from-brand-green to-brand-green-light text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-brand-green/25"
            >
              Retry Loading
            </button>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {activeSubscription && (
              <div className="inline-flex items-center gap-2 bg-brand-green/10 backdrop-blur-sm border border-brand-green/20 text-brand-green px-6 py-3 rounded-full">
                ...
                <span className="font-medium">Active: {activeSubscription.plan?.name}</span>
        ...
        <section className="pb-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {plans.slice(0, 3).map((plan, index) => {
                ...
                const isCurrent = isCurrentPlan(plan.id, activeSubscription);
                ...
                return (
                  ...
                  >
                    {/* Card */}
                    <div className={`relative bg-white/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border transition-all duration-300 ${
                      isPopular 
                      ...
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                        <div className="flex-1">
                          <div className="flex items-center gap-4 mb-3">
                            ...
                            <div>
                              <h4 className="text-xl font-bold text-gray-900 font-heading">{plan.name}</h4>
