  ...
  const features = [
    {
      ...
      description:
        "Decrease sick days and presenteeism through comprehensive wellness support.",
      icon: <CheckCircle className="w-6 h-6" />,
    },
    {
      title: "Boost productivity",
      description:
        "Improve team engagement and performance with evidence-based wellness strategies.",
      icon: <TrendingUp className="w-6 h-6" />,
    },
    {
      title: "Improve retention",
      description:
        "Create a supportive culture that makes employees want to stay and thrive.",
      icon: <Heart className="w-6 h-6" />,
    },
    {
      title: "Support mental health",
      description:
        "Build emotional resilience and create safe spaces for mental health discussions.",
      icon: <Shield className="w-6 h-6" />,
    },
    {
      title: "Create inclusive workplaces",
      description:
        "Foster diversity, belonging, and psychological safety for all team members.",
      icon: <Users className="w-6 h-6" />,
    },
    {
      title: "Boost engagement",
      description:
        "Increase team motivation and active participation in wellness initiatives.",
      icon: <Zap className="w-6 h-6" />,
    },
    {
      title: "Deliver better experience",
      description:
        "Enhance overall employee satisfaction and workplace culture.",
      icon: <Award className="w-6 h-6" />,
    },
    {
      title: "Increase enterprise value",
      description:
        "Demonstrate ESG values and create strategic competitive advantages.",
...
const Feature = ({
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 relative z-10 px-10 text-brand-green">{icon}</div>
  ...
  const services = [
    {
      ...
      description:
        "Tailored support, policy guidance and training for teams to create inclusive workplace environments.",
      icon: Heart,
      color: "bg-[#E0F8F8]",
    },
    {
      ...
      description:
        "Your wellness partner to develop or refresh your Workplace wellbeing programme with policy, strategy, and planning.",
      icon: BookOpen,
      color: "bg-[#F6F2FF]",
    },
    {
      ...
      description:
        "Frameworks and onboarding for peer-led wellbeing ambassadors; sessions to help you embed wellbeing and educate those passionate about supporting others (certificate awarded).",
      icon: Award,
      color: "bg-[#FFF0E7]",
    },
    {
      ...
      description:
        "Collaborative audits / needs assessments to identify gaps and opportunities in your current wellness approach.",
      icon: Activity,
      color: "bg-[#E5FBEC]",
    },
    {
      ...
      description:
        "Workshops tailored to support your policy, strategy and equip your team with necessary knowledge and awareness.",
      icon: User,
      color: "bg-[#FFF0E7]",
    },
    {
      ...
      description:
        "Engaging resources for internal comms and campaigns to maintain consistent wellness messaging across your organization.",
      icon: BookOpen,
      color: "bg-[#E0F8F8]",
    },
    {
      ...
      description:
        "Open and transparent sessions on midlife transitions, supporting an aging / diverse workforce, mental health and more.",
      icon: Users,
      color: "bg-[#F6F2FF]",
    },
    {
      ...
      description:
        "Helping you to co-create a welcoming office environment that fosters physical, mental and social wellness, including tech free zones and quiet spaces.",
      icon: Shield,
      color: "bg-[#FFF0E7]",
    },
    {
      ...
      description:
        "Working with therapists, nutritionists, financial and cyber wellbeing partners (and much more) we can create bespoke wellness support to suit your needs.",
      icon: Zap,
      color: "bg-[#E5FBEC]",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-base sm:text-lg text-white leading-relaxed mb-6">
                At Fifty Firsts Wellness, we help businesses build wellbeing
                into the everyday, building a foundation of performance and
                belonging; not a perk, but as a strategic advantage.
              </p>
              <p className="text-base sm:text-lg text-white leading-relaxed">
                We know that when people feel supported, connected and
                empowered, they show up differently. They're more engaged, more
                resilient and more likely to thrive.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          <div className="text-center mb-12">
            ...
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-3xl mx-auto">
              We work with businesses to co-create wellness solutions that are
              strategic, scalable, inclusive, and actionable.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-base sm:text-lg text-white leading-relaxed max-w-3xl mx-auto">
              Our services support your compliance with the Employment Rights
              Bill and help create a culture where wellbeing is an integral
              strategy.
            </p>
          </div>
                ...
                >
                  {services.map((service, index) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`${service.color} rounded-2xl p-6 transition-shadow hover:shadow-lg h-full`}
                        >
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-base sm:text-lg text-gray-700 leading-relaxed max-w-3xl mx-auto mb-6">
              Wellness isn't a nice-to-have, it's a performance enabler. When
              done well, it helps transform your workplace culture and business
              outcomes.
            </p>
            <p className="text-base sm:text-lg text-gray-700 leading-relaxed max-w-4xl mx-auto">
              We don't do one-size-fits-all. We listen, adapt and build with
              you, not for you. Whether you're just starting your wellness
              programme or looking to deepen your impact, we'll meet you where
              you are and help you move forward with clarity and confidence.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          <div className="text-center">
            ...
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-3xl mx-auto mb-8">
              Contact us today for a free 30 minutes discovery call and let's
              discuss how we can help build wellbeing into your everyday
              business strategy.
            </p>
            <Link
              to="/contact"
