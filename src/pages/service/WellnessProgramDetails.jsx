    ...
    <main className="">
      ...
      <article className="w-full flex flex-col lg:flex-row gap-8 h-fit">
        <section className="w-full lg:w-1/2 flex flex-col gap-3 justify-between">
          ...
          <div>
            <div className="text-xl sm:text-2xl font-medium">About Program</div>
            <div className="text-sm sm:text-base">
              ...
              important than ever. But wellness isn’t just about yoga mats and
              fresh fruit—it’s about cultivating a culture where people feel
              supported, valued, and balanced.
            </div>
          </div>
        </section>
      ...
      {/* About Program */}
      <div className="text-xl sm:text-2xl font-medium mt-8">About Program</div>
      <div className="text-sm sm:text-base">
        In an age where many professionals spend more waking hours at work than
        anywhere else, prioritizing wellness in the workplace is more important
        than ever. But wellness isn’t just about yoga mats and fresh fruit—it’s
        about cultivating a culture where people feel supported, valued, and
        balanced.
      </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
          {[martin4, martin2, martin3, martin1].map((img, idx) => (
            <div key={idx} className="text-center">
              ...
              <div className="text-[#667085] text-sm">Wellness Consultant</div>
            </div>
          ))}
        </div>
      </section>
