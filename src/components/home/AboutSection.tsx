...
const AboutSection: React.FC = () => {
  return (
    <section className="w-full py-40 sm:py-52 bg-brand-green-dark">
      ...
      >
        ...
        <div className="mt-8">
          <Link
            to="/about"
            className="inline-block bg-brand-green-light text-white px-6 py-2 rounded-full font-semibold hover:bg-brand-green-light/80 transition-colors"
          >
            Learn more
          </Link>
        </div>
